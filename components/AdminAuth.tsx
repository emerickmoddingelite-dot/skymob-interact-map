  ...
  return (
    <div className="relative">
      <button
        ...
        className="bg-gray-800 hover:bg-gray-900 text-white py-2 px-4 rounded-lg transition-colors font-medium"
      >
        🔐 Admin
      </button>
      ...
      {showLogin && (
        <div className="absolute top-full right-0 mt-2 bg-white/95 backdrop-blur rounded-lg p-4 shadow-xl z-50 w-64">
          <h3 className="text-lg font-bold text-gray-900 mb-3">Connexion Admin</h3>
